...
pub type R = crate::R<C3CSRrs>;
#[doc = "Register `C3CSR` writer"]
pub type W = crate::W<C3CSRrs>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<C3CSRrs> {
        EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - COMP_DEGLITCH_EN"]
    #[inline(always)]
    #[must_use]
    pub fn comp_deglitch_en(&mut self) -> COMP_DEGLITCH_EN_W<C3CSRrs> {
        COMP_DEGLITCH_EN_W::new(self, 1)
    }
    #[doc = "Bits 4:6 - INMSEL"]
    #[inline(always)]
    #[must_use]
    pub fn inmsel(&mut self) -> INMSEL_W<C3CSRrs> {
        INMSEL_W::new(self, 4)
    }
    #[doc = "Bit 8 - INPSEL"]
    #[inline(always)]
    #[must_use]
    pub fn inpsel(&mut self) -> INPSEL_W<C3CSRrs> {
        INPSEL_W::new(self, 8)
    }
    #[doc = "Bit 15 - POL"]
    #[inline(always)]
    #[must_use]
    pub fn pol(&mut self) -> POL_W<C3CSRrs> {
        POL_W::new(self, 15)
    }
    #[doc = "Bits 16:18 - HYST"]
    #[inline(always)]
    #[must_use]
    pub fn hyst(&mut self) -> HYST_W<C3CSRrs> {
        HYST_W::new(self, 16)
    }
    #[doc = "Bits 19:21 - BLANKSEL"]
    #[inline(always)]
    #[must_use]
    pub fn blanksel(&mut self) -> BLANKSEL_W<C3CSRrs> {
        BLANKSEL_W::new(self, 19)
    }
    #[doc = "Bit 22 - BRGEN"]
    #[inline(always)]
    #[must_use]
    pub fn brgen(&mut self) -> BRGEN_W<C3CSRrs> {
        BRGEN_W::new(self, 22)
    }
    #[doc = "Bit 23 - SCALEN"]
    #[inline(always)]
    #[must_use]
    pub fn scalen(&mut self) -> SCALEN_W<C3CSRrs> {
        SCALEN_W::new(self, 23)
    }
    #[doc = "Bit 31 - LOCK"]
    #[inline(always)]
    #[must_use]
    pub fn lock(&mut self) -> LOCK_W<C3CSRrs> {
        LOCK_W::new(self, 31)
    }
}
#[doc = "Comparator control/status register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`c3csr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`c3csr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C3CSRrs;
impl crate::RegisterSpec for C3CSRrs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c3csr::R`](R) reader structure"]
impl crate::Readable for C3CSRrs {}
#[doc = "`write(|w| ..)` method takes [`c3csr::W`](W) writer structure"]
impl crate::Writable for C3CSRrs {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets C3CSR to value 0"]
impl crate::Resettable for C3CSRrs {
