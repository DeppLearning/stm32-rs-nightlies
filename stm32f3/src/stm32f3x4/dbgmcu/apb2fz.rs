...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim15_stop(&mut self) -> DBG_TIM15_STOP_W<APB2FZrs> {
        DBG_TIM15_STOP_W::new(self, 2)
    }
    #[doc = "Bit 3 - Debug Timer 16 stopped when Core is halted"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim16_stop(&mut self) -> DBG_TIM16_STOP_W<APB2FZrs> {
        DBG_TIM16_STOP_W::new(self, 3)
    }
    #[doc = "Bit 4 - Debug Timer 17 stopped when Core is halted"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim17_sto(&mut self) -> DBG_TIM17_STO_W<APB2FZrs> {
        DBG_TIM17_STO_W::new(self, 4)
    }
    #[doc = "Bit 5 - Debug Timer 19 stopped when Core is halted"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_tim19_stop(&mut self) -> DBG_TIM19_STOP_W<APB2FZrs> {
        DBG_TIM19_STOP_W::new(self, 5)
    }
}
#[doc = "APB High Freeze Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`apb2fz::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`apb2fz::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct APB2FZrs;
